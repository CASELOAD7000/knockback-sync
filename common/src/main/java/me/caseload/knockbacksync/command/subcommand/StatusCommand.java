                        ...
                        .handler(context -> {
                            ...
                            if (targetSelector == null) {
                                ...
                                if (sender.hasPermission(STATUS_SELF_PERMISSION, true)) {
                                    ...
                                    if (!sender.isConsole()) {
                                        showPlayerStatus(sender, KnockbackSyncBase.INSTANCE.platformServer.getPlayer(sender.getUniqueId()));
                                    }
                                } else {
                                    sender.sendMessage(ChatUtil.translateAlternateColorCodes('&', "&cYou do not have permission to check your knockbacksync status."));
                                }
                            } else {
