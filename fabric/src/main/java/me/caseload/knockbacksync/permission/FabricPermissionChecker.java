...
public class FabricPermissionChecker implements PermissionChecker {
    ...
    public boolean hasPermission(ServerCommandSource source, String permission, boolean defaultIfUnset) {
    ...
    public boolean hasPermission(Object nativeType, String s, boolean defaultIfUnset) {
        if (nativeType instanceof ServerCommandSource commandSourceStack) {
